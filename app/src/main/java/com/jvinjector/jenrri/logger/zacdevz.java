package com.jvinjector.jenrri.logger;
...
//    public static int Tres = ClientServerHello.Bleeh;
    ...
    public static void damn(Long mDownload, Long mUpload) {
